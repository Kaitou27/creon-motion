...
export default function StartProjectSection() {
	...
	return (
		<section id="start-project" className="relative bg-gradient-to-br from-[#001A1F] via-[#002A2F] to-[#001A1F] py-16 text-white overflow-hidden" style={{ fontFamily: 'var(--font-montserrat)' }}>
			...
			<div className="max-w-6xl mx-auto px-4 relative">
				...
				>
					...
					<div className="flex justify-center mt-8">
						<a
							href="https://creonmotion.com/quote"
							target="_blank"
