...
import { Video, Target, Scissors, Layers, FileText, Compass, Zap, Box, Search, Headphones, Lightbulb, FastForward, TrendingUp, Users, ArrowRight } from 'lucide-react';
import AOS from 'aos';
import 'aos/dist/aos.css';

const InclusionsAuthority = () => {
  useEffect(() => {
    AOS.init({ once: true });
  }, []);

  const inclusions = [
    { text: "Up to 6–8 videos per month (depending on project complexity)", icon: Video },
    { text: "Complete hook and intro strategy", icon: Target },
    { text: "Advanced retention editing", icon: Scissors },
    { text: "Deep story structuring", icon: Layers },
    { text: "Script improvement recommendations", icon: FileText },
    { text: "Content flow guidance before production", icon: Compass },
    { text: "Custom motion graphics and visual systems", icon: Zap },
    { text: "Maps, data visualizations, and advanced 3D sequences", icon: Box },
    { text: "Advanced research integration", icon: Search },
    { text: "Cinematic sound design", icon: Headphones },
    { text: "Creative direction support", icon: Lightbulb },
    { text: "Priority workflow and communication", icon: FastForward },
    { text: "Retention and storytelling recommendations", icon: TrendingUp },
    { text: "Dedicated creative partnership", icon: Users }
  ];
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24" data-aos="fade-up" data-aos-duration="800">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8 text-white tracking-tight uppercase drop-shadow-md">
            <span className="text-2xl md:text-3xl text-[#00E0FF] block mb-2 tracking-widest">Starting at</span>
            $5,500 <span className="text-2xl md:text-3xl text-[#00E0FF] drop-shadow-[0_0_15px_rgba(0,224,255,0.4)]">/ month</span>
          </h2>
          
          <div className="max-w-4xl mx-auto space-y-6 px-4">
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed font-semibold">
              A dedicated creative partner focused on retention, storytelling, and long-term content growth.
            </p>
            <p className="text-base md:text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto">
              Built for brands and creators who want high-level content without building an in-house production team.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0A0F1A] to-[#0F1F2A] rounded-3xl border border-[#00E0FF]/40 p-8 sm:p-12 md:p-16 text-center max-w-5xl mx-auto shadow-[0_0_50px_rgba(0,224,255,0.15)] relative overflow-hidden group" data-aos="zoom-in" data-aos-duration="1000">
          ...
          <div className="relative z-10">
            ...
            <p className="text-2xl md:text-3xl text-white font-medium mb-16 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Brands and creators investing in authority, audience growth, and long-term content performance.
            </p>
...
export default InclusionsAuthority;
