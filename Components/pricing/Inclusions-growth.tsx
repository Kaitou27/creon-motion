...
import { Video, Target, Scissors, Layers, Image, Zap, Map, Search, Music, MessageSquare, RotateCcw, ArrowRight } from 'lucide-react';
import AOS from 'aos';
...
const InclusionsGrowth = () => {
  ...
  const inclusions = [
    { text: "Up to 4–6 videos per month (8–10 minutes each)", icon: Video },
    { text: "Hook refinement and intro improvement", icon: Target },
    { text: "Retention-focused editing throughout the video", icon: Scissors },
    { text: "Story structure and flow improvement", icon: Layers },
    { text: "Strategic visual sequencing", icon: Image },
    { text: "Motion graphics that support understanding", icon: Zap },
    { text: "Maps and data visualizations", icon: Map },
    { text: "Research-assisted visual sourcing", icon: Search },
    { text: "Sound design that supports pacing and emotion", icon: Music },
    { text: "Retention and storytelling recommendations", icon: MessageSquare },
    { text: "Unlimited revisions", icon: RotateCcw }
  ];
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24" data-aos="fade-up" data-aos-duration="800">
          <div className="inline-block mb-8 relative">
            <span className="absolute -top-5 left-1/2 transform -translate-x-1/2 bg-[#00E0FF] text-[#001A1F] text-[10px] px-3 py-1 rounded-full font-black tracking-widest uppercase shadow-[0_0_20px_rgba(0,224,255,0.6)] whitespace-nowrap z-20 border border-[#001A1F]">
              Most Popular
            </span>
            <span className="text-[#00E0FF] font-bold tracking-widest text-xs sm:text-sm uppercase bg-[#00E0FF]/10 px-8 py-2.5 rounded-full border border-[#00E0FF]/20 shadow-[0_0_15px_rgba(0,224,255,0.15)] block relative z-10 mt-2">
              Growth Plan
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8 text-white tracking-tight uppercase drop-shadow-md">
            $3,200 <span className="text-2xl md:text-3xl text-[#00E0FF] drop-shadow-[0_0_15px_rgba(0,224,255,0.4)]">/ month</span>
          </h2>
          
          <div className="max-w-4xl mx-auto space-y-6 px-4">
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed font-semibold">
              Built to keep viewers watching, not just deliver another upload.
            </p>
            <p className="text-base md:text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto">
              Designed for creators focused on retention, watch time, and audience growth.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0A0F1A] to-[#0F1F2A] rounded-3xl border border-[#00E0FF]/40 p-8 sm:p-12 md:p-16 text-center max-w-5xl mx-auto shadow-[0_0_50px_rgba(0,224,255,0.15)] relative overflow-hidden group" data-aos="zoom-in" data-aos-duration="1000">
          ...
          <div className="relative z-10">
            ...
            <p className="text-2xl md:text-3xl text-white font-medium mb-16 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Creators looking to improve audience retention, strengthen storytelling, and scale their content.
            </p>
