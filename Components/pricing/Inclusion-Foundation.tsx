...
import { Video, Scissors, Target, Zap, Film, Type, Music, Activity, RotateCcw, ArrowRight } from 'lucide-react';
import AOS from 'aos';
import 'aos/dist/aos.css';

const InclusionFoundation = () => {
  useEffect(() => {
    AOS.init({ once: true });
  }, []);

  const inclusions = [
    { text: "Up to 4 videos per month (10-15 minutes each)", icon: Video },
    { text: "Professional editing with clean pacing and structure", icon: Scissors },
    { text: "Basic hook improvement", icon: Target },
    ...
    { text: "Basic retention-focused editing", icon: Activity },
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24" data-aos="fade-up" data-aos-duration="800">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-8 text-white tracking-tight uppercase drop-shadow-md">
            $1,800 <span className="text-2xl md:text-3xl text-[#00E0FF] drop-shadow-[0_0_15px_rgba(0,224,255,0.4)]">/ month</span>
          </h2>
          
          <div className="max-w-4xl mx-auto space-y-6 px-4">
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed font-semibold">
              For creators who want consistent content with stronger structure and viewer engagement.
            </p>
            <p className="text-base md:text-lg text-gray-400 leading-relaxed max-w-3xl mx-auto">
              Professional editing designed to improve pacing, clarity, and overall viewing experience.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#0A0F1A] to-[#0F1F2A] rounded-3xl border border-[#00E0FF]/40 p-8 sm:p-12 md:p-16 text-center max-w-5xl mx-auto shadow-[0_0_50px_rgba(0,224,255,0.15)] relative overflow-hidden group" data-aos="zoom-in" data-aos-duration="1000">
          ...
          <div className="relative z-10">
            ...
            <p className="text-2xl md:text-3xl text-white font-medium mb-16 max-w-3xl mx-auto leading-relaxed drop-shadow-md">
              Creators building consistency and improving content quality without managing a full creative team.
            </p>
...
export default InclusionFoundation;
